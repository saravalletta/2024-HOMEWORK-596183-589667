...
public class testStanzaBloccata { 
	...
	public void setUp() throws Exception {
		sb = new StanzaBloccata("StanzaBloccata", "grimaldello", Direzioni.ovest);
	...
	public void testGetStanzaAdiacenteDirezioneBloccata() {
		assertNotEquals(sb, sb.getStanzaAdiacente(Direzioni.est));
	}
