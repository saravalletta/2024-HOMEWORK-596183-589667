...
public class Stanza {
    ...
    private Map<Direzioni, Stanza> direzioni2stanze;
    ...
    public void setStanzeAdiacenti(Map<Direzioni, Stanza> stanzeAdiacenti) {
    ...
    public boolean addAttrezzo(Attrezzo attrezzo) {
        if (this.numeroAttrezzi < NUMERO_MASSIMO_ATTREZZI && (this.getAttrezzo(attrezzo.getNome())==null)) {
